...
import { CollectionWithMeta, Pack , Interaction} from '@/components/rmrk/service/scheme'
...
export default class Profile extends mixins(PrefixMixin, InfiniteScrollMixin, ChainMixin,
) {
